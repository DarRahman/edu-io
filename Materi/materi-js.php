      ...
      <section class="materi-card">
        ...
        <div class="concept-grid">
          <div class="concept-card">
            ...
            <code
              >"Hello World"<br />'JavaScript'<br />`Template ${literal}`</code
            >
          </div>
      ...
      <section class="materi-card">
        ...
        <div class="concept-grid">
          <div class="concept-card">
            ...
            <code
              >document.getElementById()<br />document.querySelector()<br />document.querySelectorAll()</code
            >
          </div>
          ...
          <div class="concept-card">
            ...
            <code
              >element.innerHTML<br />element.textContent<br />element.style<br />element.className</code
            >
          </div>
          ...
          <div class="concept-card">
            ...
            <code
              >addEventListener()<br />onclick, onchange<br />onmouseover,
              onkeydown</code
            >
          </div>
        </div>
...
document.getElementById('todoForm')
    .addEventListener('submit', function(e) {
      ...
      <section class="materi-card">
        ...
        <div
          class="info-box"
          style="border-left-color: #9b59b6; margin-top: 20px"
        >
