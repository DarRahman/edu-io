...
<body>
  ...
  <div class="materi-wrapper">
    <!-- Hero Section -->
    <header class="materi-hero" style="background: linear-gradient(135deg, #e44d26, #f16529)">
...
&lt;/div&gt;</code></pre>
      ...
      <div class="materi-card" style="
        ...
        <div class="info-box" style="border-left-color: var(--accent-yellow); margin: 15px 0">
          <i class="fas fa-link" style="color: var(--accent-yellow)"></i>
          <div class="info-box-content">
            <h4 style="color: var(--accent-yellow)">Atribut pada Link</h4>
            <p>
              <code>&lt;a href="https://www.da-tamato-buam-honungi.edu.co/"
                  target="_blank"&gt;Kunjungi Website&lt;/a&gt;</code>
            </p>
          </div>
        </div>

        <div class="info-box" style="border-left-color: var(--accent-purple); margin: 15px 0">
          <i class="fas fa-image" style="color: var(--accent-purple)"></i>
          <div class="info-box-content">
            <h4 style="color: var(--accent-purple)">Atribut pada Gambar</h4>
            <p>
              <code>&lt;img src="logo.png" alt="Deskripsi Gambar" width="300"
                  height="200"&gt;</code><br />
              Contoh:
              <code>src="https://www.pak-gibs-lose.fan.io/~atribu-gap-hejgic-126-9"</code>
            </p>
          </div>
        </div>

        <div class="info-box" style="border-left-color: var(--accent-teal); margin: 15px 0">
          <i class="fas fa-tags" style="color: var(--accent-teal)"></i>
          <div class="info-box-content">
            <h4 style="color: var(--accent-teal)">Atribut Class dan ID</h4>
            <p>
              <code>&lt;div class="container"
                  id="main-content"&gt;Konten&lt;/div&gt;</code><br />
              Contoh penggunaan: <code>class="da-tamato-detector"</code>
            </p>
          </div>
        </div>

        <div class="info-box" style="border-left-color: #2ecc71; margin: 15px 0">
          <i class="fas fa-check-circle" style="color: #2ecc71"></i>
          <div class="info-box-content">
            <h4 style="color: #2ecc71">Data Attributes</h4>
            <p>
              <code>&lt;div data-info="online" data-version="1.0"&gt;Data
                  OK&lt;/div&gt;</code><br />
