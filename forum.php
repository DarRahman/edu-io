...
<body>
                ...
                <div class="materi-card"
                    ...
                    <?php if ($isQuestionOwner): ?>
                        <form method="POST" action="forum.php" style="position: absolute; top: 15px; right: 15px; z-index: 10;">
                            ...
                            <button type="submit" name="delete_question" onclick="return confirmDelete('pertanyaan')"
                                ...
                                <div
                                    ...
                                    <?php if ($isAnswerOwner): ?>
                                        <form method="POST" action="forum.php"
                                            ...
                                            <button type="submit" name="delete_answer" onclick="return confirmDelete('jawaban')"
    ...
    <script>
        ...
        function confirmDelete(type) {
            return confirm(`Apakah Anda yakin ingin menghapus ${type} ini? Tindakan ini tidak dapat dibatalkan.`);
        }
