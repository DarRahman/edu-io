...
session_start();
include 'koneksi.php';
if (!isset($_SESSION['loggedInUser'])) { header("Location: login.php"); exit; }
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <style>
        ...
        .generated-quiz {
            display: none; /* Sembunyi sebelum digenerate */
            text-align: left;
            margin-top: 30px;
        }
        .quiz-item {
      ...
      <ul class="nav-links">
        ...
        <li class="dropdown active">
          ...
          <div class="dropdown-content">
            ...
            <a href="playground.php">Live Coding</a>
            <a href="ai_quiz.php" class="active-item">AI Quiz</a>
          </div>
        </li>
    ...
    <div class="container">
        <div class="quiz-generator-box">
            ...
            <div style="display: flex; gap: 10px; margin-top: 20px;">
                <input type="text" id="topicInput" class="input-group" placeholder="Contoh: CSS Flexbox, Sejarah Indonesia, Python..." style="flex: 1; padding: 12px; border-radius: 8px; border: 1px solid var(--border-color);">
