            ...
            <div class="quiz-options-grid">
              ...
              <label class="quiz-option-label">
                ...
                <div class="quiz-option-content">
                  ...
                  <span class="quiz-option-text"
                    >HighText Machine Language</span
                  >
                </div>
              </label>
              <label class="quiz-option-label">
                ...
                <div class="quiz-option-content">
                  ...
                  <span class="quiz-option-text"
                    >Hyperlink and Text Markup Language</span
                  >
                </div>
              </label>
            </div>
            ...
            <div class="quiz-options-grid">
              ...
              <label class="quiz-option-label">
                ...
                <div class="quiz-option-content">
                  <span class="quiz-option-marker">B</span>
                  <span class="quiz-option-text"
                    >Menampilkan teks bergaya miring</span
                  >
                </div>
              </label>
              <label class="quiz-option-label">
                ...
                <div class="quiz-option-content">
                  <span class="quiz-option-marker">C</span>
                  <span class="quiz-option-text"
                    >Menentukan lokasi file tujuan hyperlink</span
                  >
                </div>
              </label>
            </div>
            ...
            <div class="quiz-options-grid">
              ...
              <label class="quiz-option-label">
                ...
                <div class="quiz-option-content">
                  <span class="quiz-option-marker">C</span>
                  <span class="quiz-option-text"
                    >Menentukan struktur dan isi halaman web</span
                  >
                </div>
              </label>
            </div>
