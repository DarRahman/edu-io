...
<body>
    ...
    <nav class="navbar">
      ...
      <ul class="nav-links">
        ...
        <li><a href="kuis.php">Kuis</a></li> <!-- Menu Kuis akan diaktifkan oleh JS -->
      ...
      <main>
        ...
        <div class="materi-grid">
          <a href="Kuis/kuis-html.html" class="materi-card">
            <div class="materi-card-header"><i class="fab fa-html5"></i><h3>Kuis: Pengenalan HTML</h3></div>
          ...
          <a href="Kuis/kuis-css.html" class="materi-card">
            <div class="materi-card-header"><i class="fab fa-css3-alt"></i><h3>Kuis: Dasar-dasar CSS</h3></div>
          ...
          <a href="Kuis/kuis-js.html" class="materi-card">
            <div class="materi-card-header"><i class="fab fa-js-square"></i><h3>Kuis: JavaScript</h3></div>
            ...
            if (!isset($_SESSION['loggedInUser'])) {
                ...
                if (mysqli_num_rows($query) > 0) {
                    while ($row = mysqli_fetch_assoc($query)) {
                        ...
                        if ($quiz_id == "html-quiz") { $icon = "fab fa-html5"; $name = "Kuis: HTML"; }
                        if ($quiz_id == "css-quiz") { $icon = "fab fa-css3-alt"; $name = "Kuis: CSS"; }
                        if ($quiz_id == "js-quiz") { $icon = "fab fa-js-square"; $name = "Kuis: JavaScript"; }
    ...
    <div id="ai-chat-window">
        ...
        <div id="ai-chat-body"><div class="ai-message bot">Halo! Saya Tutor AI edu.io. Ada yang bisa saya bantu?</div></div>
        <div class="ai-chat-footer"><input type="text" id="ai-input" placeholder="Tanyakan sesuatu..." autocomplete="off"/><button onclick="sendToAI()"><i class="fas fa-paper-plane"></i></button></div>
    </div>
