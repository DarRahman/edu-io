...
function getProfilePath($foto) {
    if (empty($foto)) return "img/default-pp.png";
...
<head>
    ...
    <style>
        ...
        /* Warna Juara */
        .rank-1 { background: #FFC312; box-shadow: 0 0 10px #FFC312; font-size: 1.2em; } /* Emas */
        .rank-2 { background: #C0C0C0; box-shadow: 0 0 10px #C0C0C0; } /* Perak */
        .rank-3 { background: #CD7F32; box-shadow: 0 0 10px #CD7F32; } /* Perunggu */
...
<body>
    ...
    <nav class="navbar">
      <a class="logo" href="index.html">
        <img src="logo.png" alt="Logo Edu.io" height="70" width="150" class="logo-img"/>
      </a>
      <ul class="nav-links">
            ...
            <table class="rank-table">
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        $badgeContent = $rank;
                        if ($rank == 1) { $badgeClass .= " rank-1"; $badgeContent = "<i class='fas fa-crown'></i>"; }
                        ...
                        <tr class="rank-row" style="<?php echo $highlightStyle; ?>">
                            ...
                            <!-- Kolom 2: Profil -->
                            <td class="rank-cell">
                                <a href="profile.php?user=<?php echo $row['username']; ?>" class="user-info" style="text-decoration: none; color: inherit;">
                                    <img src="<?php echo $pp; ?>" style="width: 50px; height: 50px; border-radius: 50%; object-fit: cover; border: 2px solid var(--border-color);">
                                    <div>
                            ...
                            <td class="rank-cell" style="text-align: right;">
                                <?php echo $row['total_point']; ?> <span style="font-size: 0.6em; color: var(--text-secondary); font-weight: 400;">Pts</span>
                            </td>
                        </tr>
    ...
    <div id="ai-chat-window">
        <div class="ai-chat-header"><span><i class="fas fa-magic"></i> edu.io AI Tutor</span><button onclick="toggleAIChat()">&times;</button></div>
        <div id="ai-chat-body"><div class="ai-message bot">Halo! Butuh bantuan?</div></div>
        <div class="ai-chat-footer"><input type="text" id="ai-input" placeholder="..." autocomplete="off"/><button onclick="sendToAI()"><i class="fas fa-paper-plane"></i></button></div>
    </div>
